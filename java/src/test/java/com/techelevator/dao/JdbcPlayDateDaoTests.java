...
public class JdbcPlayDateDaoTests extends BaseDaoTests {
    ...
    public void create_PlayDate_Creates_PlayDate() {
        PlayDate newPlayDate = new PlayDate(0, "Marley", "With Marley", 1, LocalDateTime.of(2024, 4, 25, 12, 00, 00),
                LocalDateTime.of(2024, 4, 25, 14, 00, 00), 2, true);
