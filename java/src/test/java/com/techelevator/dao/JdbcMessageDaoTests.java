...
public class JdbcMessageDaoTests extends BaseDaoTests {
    ...
    private final Message MESSAGE_ONE = new Message(1, "Best Park", "What is the best park for small dogs?", LocalDateTime.of(2024, 5, 2, 10, 30, 0), 1);
    private final Message MESSAGE_TWO = new Message(2, "Join us for a birthday party", "Throwing a birthday party for my dog Murphy - everyone is invited!", LocalDateTime.of(2024, 7, 1, 11, 30, 0), 2);
    @Before
    public void setup() {
    ...
    public void getAllMessages() {
        ...
        assertMessagesMatch(MESSAGE_ONE, messages.get(0));
        assertMessagesMatch(MESSAGE_TWO, messages.get(1));
    }
